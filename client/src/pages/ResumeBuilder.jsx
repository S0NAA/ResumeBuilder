...
const ResumeBuilder = () => {
  ...
  try {
    ...
    if (data.resume) {
      ...
      resume.project = Array.isArray(resume.project) ? resume.project : [];
  ...
  const saveResume = async () => {
    ...
    try {
      ...
      // Remove image from updatedResumeData if it's a File object
      const hasNewImage = typeof resumeData.personal_info?.image === 'object' && resumeData.personal_info.image !== null;      
      if(hasNewImage){
      ...
      if(hasNewImage && removeBackground) {
            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                ...
                <button 
                  ...
                  className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all ${activeSectionIndex === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
