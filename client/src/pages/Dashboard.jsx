...
const Dashboard = () => {
  ...
  const editTitle = async (event) => {
    ...
    try {
      ...
      setAllResume(allResume.map(resume => 
      ...
      toast.error(error?.response?.data?.message || error.message)
      // Reload resumes if update failed
      loadAllResumes()
    }
  }
    ...
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='flex gap-4'>
          ...
          >
            <PlusIcon className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-indigo-500 text-white rounded-full' />
          ...
          >
            <UploadCloudIcon className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-purple-500 text-white rounded-full' />
        ...
        <div className='grid grid-cols-2 sm:flex flex-wrap gap-4'>
          {Array.isArray(allResume) && allResume.length > 0 ? (
            ...
            <div className="col-span-2 w-full text-center py-8">
          ...
          <form onSubmit={uploadResume} onClick={() => setshowUploadResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <button 
                ...
                className='w-full py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2'
              >
